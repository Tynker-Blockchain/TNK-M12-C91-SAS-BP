...
class Block:
    ...
    def mineBlock(self):
        ...
        miningLimit = 40000
        attempts = 1
        # Debug the while condition and check why block is mined even when hash does not match the target
        while self.currentHash[self.midHash : self.midHash+self.difficulty] != target:
